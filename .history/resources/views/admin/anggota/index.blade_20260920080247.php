...
@section('content')
<h2>Anggota</h2>
<p><a href="{{ route('admin.anggota.create') }}">Tambah anggota</a></p><form method="get"><input name="q" value="{{ request('q') }}" placeholder="Cari nama atau nomor anggota"><button type="submit">Cari</button></form>
