...
class ProfilController extends Controller
{
    ...
    public function updateAdmin(Request $request): \Illuminate\Http\RedirectResponse
    {
        $user = Auth::user();
    ...
    public function updateAnggota(Request $request): \Illuminate\Http\RedirectResponse
    {
        $user = Auth::user();
        $user->update($request->validate([
            'nama_lengkap' => ['required', 'string', 'max:255'],
